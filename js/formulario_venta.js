...
function obtenerPrecio(producto) {
    // Esta función obtiene el precio del producto de la TBvalores de precios
    // Puedes reemplazar este código con una llamada a una API o base de datos
    const tablaPrecios = {
        'Cazuela': 5000,
        'Pollo con arroz': 4500,
        'Garbanzos': 4500,
        'Tequeños':3000
    };

    return tablaPrecios[producto];
